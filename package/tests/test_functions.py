...
def test_amount_dangers():
    ...
    # Test 3 : if the minimum grade is given to "Carcinogenic" and maximum garde to "Endocrine"
    assert amount_dangers (dangerous_ingredients,4,1,2) == {'Paraben': 3, 'Carcinogenic': 4, 'Endocrine': 5}, "Test 3 failed"
    # Test 4 : if the medium grade is given to "Carcinogenic" and minimum grade given to "Endocrine"
